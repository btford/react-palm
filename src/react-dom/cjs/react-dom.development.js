  ...
  (function() {
    ...
    var ReactErrorUtils = {
      ...
      invokeGuardedCallback: function(name, func, context, a, b, c, d, e, f) {
        return invokeGuardedCallback$1.apply(ReactErrorUtils, arguments);
      },
      ...
      invokeGuardedCallbackAndCatchFirstError: function(
        ...
        var returned = ReactErrorUtils.invokeGuardedCallback.apply(
          this,
          arguments
        );
    ...
    function executeDispatch(event, simulated, listener, inst) {
      ...
      var returned = ReactErrorUtils.invokeGuardedCallbackAndCatchFirstError(
        type,
        listener,
        undefined,
        event
    ...
    var executeDispatchesAndRelease = function(event, simulated) {
      if (event) {
        var returned = executeDispatchesInOrder(event, simulated);
