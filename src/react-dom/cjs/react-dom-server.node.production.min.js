...
var Y = (function() {
  function a(b, d) {
    ...
    q.isValidElement(b)
      ? b.type !== A
        ? (b = [b])
        : ((b = b.props.children), (b = q.isValidElement(b) ? [b] : W(b)))
      : (b = W(b));
    this.stack = [
      {
        type: null,
    ...
    for (var b = ''; b.length < a; ) {
      ...
      if (c.childIndex >= c.children.length) {
        ...
        'select' === c.type
          ...
          : null != c.type &&
            null != c.type.type &&
            c.type.type.$$typeof === E &&
            this.popProvider(c.type);
      } else
        (g = c.children[c.childIndex++]),
          (b += this.render(g, c.context, c.domNamespace));
    }
    return b;
  };
  a.prototype.render = function(a, d, c) {
    ...
    if ('object' === typeof b && null !== b)
      switch (b.$$typeof) {
        ...
        case F:
          return (
            (b = W(a.props.children(a.type._currentValue))),
            this.stack.push({
              type: a,
              domNamespace: c,
              children: b,
  ...
  a.prototype.renderDOM = function(a, d, c) {
    ...
    if ('input' === b)
      ...
      if (null == k) {
        ...
        null != l &&
          (null != k ? t('92') : void 0,
          Array.isArray(l) && (1 >= l.length ? void 0 : t('93'), (l = l[0])),
          (k = '' + l));
        null == k && (k = '');
      }
      f = p({}, f, {value: void 0, children: '' + k});
    } else if ('select' === b)
      (this.currentSelectValue = null != f.value ? f.value : f.defaultValue),
        (f = p({}, f, {value: void 0}));
    else if ('option' === b) {
    ...
    if ((k = f))
      ia[b] &&
        (null != k.children || null != k.dangerouslySetInnerHTML
          ? t('137', b, '')
          : void 0),
        null != k.dangerouslySetInnerHTML &&
          (null != k.children ? t('60') : void 0,
          'object' === typeof k.dangerouslySetInnerHTML &&
          '__html' in k.dangerouslySetInnerHTML
            ? void 0
            : t('61')),
        null != k.style && 'object' !== typeof k.style ? t('62', '') : void 0;
    k = f;
    ...
    for (u in k)
      if (sa.call(k, u)) {
        ...
        if (null != e) {
          ...
          h = null;
          b: if (((m = b), (n = k), -1 === m.indexOf('-')))
            m = 'string' === typeof n.is;
          else
            switch (m) {
              case 'annotation-xml':
              case 'color-profile':
    ...
    a: {
      ...
      if (null != l) {
        ...
        ((l = f.children), 'string' === typeof l || 'number' === typeof l)
      ) {
        l = R(l);
        break a;
      }
